...
{
  public class FSharpCompiledEnum : Struct, IFSharpCompiledTypeElement
  {
    public FSharpCompiledType CompiledType { get; }

    public FSharpCompiledEnum(FSharpCompiledType compiledType, [NotNull] ICompiledEntity parent,
