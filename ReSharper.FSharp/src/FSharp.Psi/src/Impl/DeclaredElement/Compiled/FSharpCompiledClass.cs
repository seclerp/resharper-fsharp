...
{
  public class FSharpCompiledClass : Class, IFSharpCompiledTypeElement
  {
    public FSharpCompiledType CompiledType { get; }

    public FSharpCompiledClass(FSharpCompiledType compiledType, [NotNull] ICompiledEntity parent,
