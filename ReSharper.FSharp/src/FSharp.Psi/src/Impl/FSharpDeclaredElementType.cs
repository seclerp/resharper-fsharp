...
namespace JetBrains.ReSharper.Plugins.FSharp.Psi.Impl
{
  ...
  {
    public static readonly DeclaredElementType ActivePatternCase =
      new FSharpDeclaredElementType("active pattern case", null);
    ...
    public override bool IsPresentable(PsiLanguageType language) => language.Is<FSharpLanguage>();
  }
}
