...
type FSharpCompletionTest() =
    ...
    [<Test; Explicit>] member x.``Lambda - Arg - Curried - Tuple 01 - First``() = x.DoNamedTest()
    [<Test; Explicit>] member x.``Lambda - Arg - Curried - Tuple 02 - Last``() = x.DoNamedTest()
    [<Test; Explicit>] member x.``Lambda - Arg - Curried 01``() = x.DoNamedTest()
    [<Test; Explicit>] member x.``Lambda - Arg - Curried 02``() = x.DoNamedTest()
    [<Test; Explicit>] member x.``Lambda - Arg - Curried 03``() = x.DoNamedTest()
    [<Test; Explicit>] member x.``Lambda - Pipe - Double 01``() = x.DoNamedTest()
    [<Test; Explicit>] member x.``Lambda - Pipe 01``() = x.DoNamedTest()
    [<Test; Explicit>] member x.``Lambda - Pipe 02``() = x.DoNamedTest()
    [<Test; Explicit>] member x.``Lambda - Pipe 03 - Parens``() = x.DoNamedTest()
